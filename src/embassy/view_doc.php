                  ...
                  <div class="col-12">
                    ...
                    <div class="list-group">
                      ...
                      foreach ($file_urls as $url) {
                          $url = trim($url);
                          if (!empty($url)) {
                              echo '<a href="../s3upload/download?key=' . htmlspecialchars(urlencode($url)) . '&code=' . htmlspecialchars($document['verification_code']) . '" class="list-group-item list-group-item-action" target="_blank">';
